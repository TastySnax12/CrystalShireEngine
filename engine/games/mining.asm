...
DEF PICK_HIT_SFX       EQU SFX_EGG_CRACK
DEF HAMMER_HIT_SFX     EQU SFX_BELLY_DRUM
DEF WALL_HIT_SFX       EQU SFX_SHINE
DEF ITEM_GET_SFX       EQU SFX_HIT_END_OF_EXP_BAR
DEF COLLAPSE_SHAKE_SFX EQU SFX_MOVE_PUZZLE_PIECE
DEF COLLAPSE_ANIM_SFX  EQU SFX_MOVE_PUZZLE_PIECE
...
DEF MINING_GAME_MIN_CRACK EQU 10
DEF MINING_GAME_MAX_HITS EQU 57 + MINING_GAME_MIN_CRACK

DEF MINING_GAME_NUM_ITEMS EQU 19

DEF NUM_UNIQUE_ROCK_LAYERS EQU 32
DEF NUM_ROCK_LAYERS EQU NUM_UNIQUE_ROCK_LAYERS * 2
...
.loop
	...
	ld a, $a0
	ld [wShadowOAMSprite17], a
	xor a
	ld [wShadowOAMSprite17 + 1], a
	ld [wShadowOAMSprite17 + 2], a
	ld [wShadowOAMSprite17 + 3], a
	ret
...
MiningGame_PlaceCursor:
	...
	add hl, hl
	ld a, l
	ld [wShadowOAMSprite16 + 0], a
	ld a, h
	ld [wShadowOAMSprite16 + 1], a
	ld a, $30
	ld [wShadowOAMSprite16 + 2], a
	ld a, [wMiningTool]
	and a
	ld a, 6
	jr z, .got_pal
