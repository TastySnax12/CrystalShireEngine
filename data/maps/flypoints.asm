...
; Johto
	...
	db LANDMARK_TWINLEAF_TOWN,    SPAWN_TWINLEAF
	db LANDMARK_SANDGEM_TOWN,     SPAWN_SANDGEM
	db LANDMARK_JUBILIFE_CITY,    SPAWN_JUBILIFE
	db LANDMARK_OREBURGH_CITY,    SPAWN_OREBURGH
