...
MapGroup_Dungeons:
	...
	map EternaGalacticBuilding1F, TILESET_FACILITY, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_ETERNA_FOREST, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaGalacticBuilding2F, TILESET_FACILITY, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_ETERNA_FOREST, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaGalacticBuilding3F, TILESET_FACILITY, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_ETERNA_FOREST, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaGalacticBuilding4F, TILESET_FACILITY, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_ETERNA_FOREST, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OldChateau, TILESET_CAVE, DUNGEON, LANDMARK_OLD_CHATEAU, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map OldChateauDining, TILESET_OLD_CHATEAU, DUNGEON, LANDMARK_OLD_CHATEAU, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map OldChateauBedrooms, TILESET_OLD_CHATEAU, DUNGEON, LANDMARK_OLD_CHATEAU, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map WaywardCave1F, TILESET_CAVE_2, DUNGEON, LANDMARK_WAYWARD_CAVE, MUSIC_OREBURGH_GATE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map WaywardCave1F2, TILESET_CAVE_2, DUNGEON, LANDMARK_WAYWARD_CAVE, MUSIC_OREBURGH_GATE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map WaywardCaveB1F, TILESET_CAVE_2, DUNGEON, LANDMARK_WAYWARD_CAVE, MUSIC_OREBURGH_GATE, FALSE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Eterna:
	...
	map EternaPokeMart, TILESET_MART, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_POKE_MART, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaGym, TILESET_GYM_2, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaBikeShop, TILESET_BIKE_SHOP, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaHerbShop, TILESET_HOUSE, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaUndergroundHouse, TILESET_MUSEUM, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaApartment1F, TILESET_MODERN_INTERIOR, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaApartment2F, TILESET_MODERN_INTERIOR, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaApartment3F, TILESET_MODERN_INTERIOR, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaHouseW, TILESET_HOUSE, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EternaHouseE, TILESET_HOUSE, INDOOR, LANDMARK_ETERNA_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Route211West, TILESET_SINNOH_3, ROUTE, LANDMARK_ROUTE_211, MUSIC_ROUTE_205, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route206EternaNorthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_206, MUSIC_ROUTE_206, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route206EternaSouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_206, MUSIC_ROUTE_206, FALSE, PALETTE_DAY, FISHGROUP_SHORE
