MiningItemList:
	dw REVIVE,       .Revive      ; 01
	dw ODD_KEYSTONE, .OddKeystone ; 02
	dw MOON_STONE,   .MoonStone   ; 03
	dw LEAF_STONE,   .LeafStone   ; 04
	dw EVERSTONE,    .Everstone   ; 05
	dw STAR_PIECE,   .StarPiece   ; 06
	dw HARD_STONE,   .HardStone   ; 07
	dw MASTER_BALL,  .HelixFossil ; 08
	dw MASTER_BALL,  .DomeFossil  ; 09
	dw MAX_REVIVE,   .MaxRevive   ; 0a
	dw MASTER_BALL,  .OldAmber    ; 0b
	dw MASTER_BALL,  .RootFossil  ; 0c
	dw MASTER_BALL,  .ClawFossil  ; 0d
	dw MASTER_BALL,  .ArmorFossil ; 0e
	dw MASTER_BALL,  .SkullFossil ; 0f
	dw MASTER_BALL,  .HeartScale  ; 10
	dw FIRE_STONE,   .FireStone   ; 11
	dw THICK_CLUB,   .ThickClub   ; 12
	dw WATER_STONE,  .WaterStone  ; 13
...
DEF collast EQUS "PAL_COLOR_SIZE, PAL_COLOR_SIZE * 3"
