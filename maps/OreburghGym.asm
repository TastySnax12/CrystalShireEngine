...
OreburghGym_MapScripts:
	def_scene_scripts
	scene_script OreburghGym_NoopScene, OREBURGHGYM_SCENE_DEFAULT
	scene_script OreburghGym_NoopScene, OREBURGHGYM_SCENE_FINISHED

	def_callbacks

OreburghGym_NoopScene:
	end

OreburghGym_BridgeOn:
	callasm .Bridge
	setscene OREBURGHGYM_SCENE_FINISHED
	end
...
OreburghGym_BridgeOff:
	callasm .Bridge
	setscene OREBURGHGYM_SCENE_DEFAULT
	end
...
.FightDone:
	checkevent EVENT_GOT_TM76_STEALTH_ROCK
	iftrue .AfterTM
	writetext .BadgeText
	buttonsound
	verbosegiveitem POKE_BALL ;TM_STEALTH_ROCK
	iffalse .BagFull
	setevent EVENT_GOT_TM76_STEALTH_ROCK
	writetext .TMText
	waitbutton
.BagFull:
	closetext
...
OreburghGym_MapEvents:
	...
	object_event  7, 18, SPRITE_GYM_GUIDE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OreburghGym_GymGuyScript, -1
