...
JubilifeCity_MapScripts:
	def_scene_scripts
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_FIRST_TIME
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_CANT_LEAVE_RIVAL
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_START_POKETCH
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_CANT_LEAVE_POKETCH
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_CANT_LEAVE_GALACTIC
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_NO_GLOBAL_TERMINAL
	scene_script JubilifeCityNoopScene, SCENE_JUBILIFECITY_NOTHING
...
JubilifeCity_PresScript:
	...
	waitbutton
	closetext
	callstd TableIndexFromFacingScript
