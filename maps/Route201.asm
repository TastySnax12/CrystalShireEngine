...
.SaidYes:
	...
	waitbutton
	closetext
	callstd TableIndexFromStarterScript
...
Route201_MapEvents:
	...
	def_coord_events
	coord_event  4, 15, SCENE_ROUTE201_FIND_RIVAL, Route201_GetStarterScriptL
	coord_event  5, 15, SCENE_ROUTE201_FIND_RIVAL, Route201_GetStarterScriptR
	coord_event  7, 13, SCENE_ROUTE201_CANT_LEAVE, Route201_CantLeaveScript1
	coord_event  5, 14, SCENE_ROUTE201_CANT_LEAVE, Route201_CantLeaveScript2
	coord_event  4, 15, SCENE_ROUTE201_FIND_RIVAL_2, Route201_RivalFollowScriptL
	coord_event  5, 15, SCENE_ROUTE201_FIND_RIVAL_2, Route201_RivalFollowScriptR
	coord_event  4, 16, SCENE_ROUTE201_RIVAL_FOLLOW, Route201_PlayerCantLeaveScript1
	coord_event  5, 16, SCENE_ROUTE201_RIVAL_FOLLOW, Route201_PlayerCantLeaveScript1
	coord_event  7, 12, SCENE_ROUTE201_RIVAL_FOLLOW, Route201_PlayerCantLeaveScript2
	coord_event  7, 13, SCENE_ROUTE201_RIVAL_FOLLOW, Route201_PlayerCantLeaveScript2

	def_bg_events
	bg_event  3, 13, BGEVENT_READ, Route201_TwinleafSignScript
	bg_event 25, 11, BGEVENT_READ, Route201_TrainerTipsSignScript
	bg_event 36,  4, BGEVENT_READ, Route201_SandgemSignScript

	def_object_events
	object_event  4, 12, SPRITE_RIVAL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_RivalScript, EVENT_ROUTE_201_RIVAL
	object_event  1, 12, SPRITE_ROWAN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_RowanScript, EVENT_ROUTE_201_ROWAN
	object_event  1, 12, SPRITE_DAWN_LUCAS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_ROUTE_201_DAWNLUCAS
	object_event  4, 13, SPRITE_BRIEFCASE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_BriefcaseScript, EVENT_ROUTE_201_BRIEFCASE
	object_event 34, 13, SPRITE_LASS, SPRITEMOVEDATA_WANDER, 2, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_GirlScript, -1
	object_event 28,  4, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_MartGuyScript, -1
	object_event 53,  8, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_LedgeKidScript, -1
	object_event 12, 12, SPRITE_ROCKER, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route201_GrassGuyScript, EVENT_ROUTE_201_GRASS_GUY
