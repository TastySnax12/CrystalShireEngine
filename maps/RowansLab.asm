...
RowansLab_MapScripts:
	def_scene_scripts
	scene_script RowansLabInitScene, SCENE_ROWANS_LAB_INIT
	scene_script RowansLabNoopScene, SCENE_ROWANS_NOOP

	def_callbacks

RowansLabInitScene:
	sdefer RowansLabFirstVisitScript
RowansLabNoopScene:
	end

RowansLabFirstVisitScript:
