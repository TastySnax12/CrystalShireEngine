...
Route202_MapScripts:
	def_scene_scripts
	scene_script Route202NoopScene, SCENE_ROUTE_202_DAWN_LUCAS
	scene_script Route202NoopScene, SCENE_ROUTE_202_FINISHED
...
Route202_CatchTutorialScript:
	...
	checkevent EVENT_STOPPED_BY_DAWN_LUCAS_ROUTE_202
	iftrue .SecondTime
	writetextgender .DawnTellFamilyText, .LucasTellFamilyText
	setevent EVENT_STOPPED_BY_DAWN_LUCAS_ROUTE_202
	sjump .Join
...
Route202_MapEvents:
	...
	def_coord_events
	coord_event 14, 16, SCENE_ROUTE_202_DAWN_LUCAS, Route202_CatchTutorialScriptU
	coord_event 14, 17, SCENE_ROUTE_202_DAWN_LUCAS, Route202_CatchTutorialScriptD
