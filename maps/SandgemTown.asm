...
SandgemTown_MapScripts:
	def_scene_scripts
	scene_script SandgemTownNoopScene, SCENE_SANDGEM_TOWN_INIT_SCENE
	scene_script SandgemTownAfterLabScene, SCENE_SANDGEM_TOWN_AFTER_LAB
	scene_script SandgemTownNoopScene, SCENE_SANDGEM_TOWN_FINISH
...
SandgemTownAfterLabScene:
	sdefer SandgemTownAfterLabScript
SandgemTownNoopScene:
	end

SandgemTownAfterLabScript:
...
; bag cannot be full normally, ignore fail case
	...
	setscene SCENE_SANDGEM_TOWN_FINISH
...
SandgemTown_FirstVisitScript:
	...
	setscene SCENE_SANDGEM_TOWN_AFTER_LAB
...
SandgemTown_MapEvents:
	...
	def_coord_events
	coord_event  4,  6, SCENE_SANDGEM_TOWN_INIT_SCENE, SandgemTown_FirstVisitScriptU
	coord_event  4,  7, SCENE_SANDGEM_TOWN_INIT_SCENE, SandgemTown_FirstVisitScriptD
