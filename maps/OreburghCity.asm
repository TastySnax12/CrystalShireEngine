...
OreburghCity_MapScripts:
	def_scene_scripts
	scene_script OreburghCityNoopScene, SCENE_OREBURGHCITY_FIRST_VISIT
	scene_script OreburghCityNoopScene, SCENE_OREBURGHCITY_AFTER_GYM
	scene_script OreburghCityNoopScene, SCENE_OREBURGHCITY_NOTHING
