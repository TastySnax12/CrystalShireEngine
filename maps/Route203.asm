...
Route203_MapScripts:
	def_scene_scripts
	scene_script Route203NoopScene, SCENE_ROUTE_203_RIVAL_WAITING
	scene_script Route203NoopScene, SCENE_ROUTE_203_NOOP
...
Route203_MapEvents:
	...
	def_coord_events
	coord_event  4, 14, SCENE_ROUTE_203_RIVAL_WAITING, Route203_RivalBattleScriptU
	coord_event  4, 15, SCENE_ROUTE_203_RIVAL_WAITING, Route203_RivalBattleScriptD
