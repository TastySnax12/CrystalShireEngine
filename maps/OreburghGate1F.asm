...
OreburghGate1F_MapScripts:
	def_scene_scripts
	scene_script OreburghGate1F_NoopScene, OREBURGHGATE1F_SCENE_DEFAULT
	scene_script OreburghGate1F_NoopScene, OREBURGHGATE1F_NOOP_SCENE

	def_callbacks

OreburghGate1F_NoopScene:
	end
...
OreburghGate1F_HikerScript:
	...
	waitbutton
	verbosegiveitem POKE_BALL ;HM_ROCK_SMASH
	setevent EVENT_GOT_HM05_ROCK_SMASH
	waitbutton
	writetext .HMExplainText
	waitbutton
	closetext
	setscene OREBURGHGATE1F_NOOP_SCENE
	end
...
OreburghGate1F_MapEvents:
	...
	def_coord_events
	coord_event  6, 15, OREBURGHGATE1F_SCENE_DEFAULT, OreburghGate1F_GiveRockSmashScript
